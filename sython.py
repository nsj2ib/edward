...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@SC_60"))
...
async def _(event):
    ...
    await event.edit(f'''
**☆ 𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 ꫀ𝑑𝑤𝑎𝑟𝑑 𝑘ꫀꪀ𝑤𝑎𝑦
☆ 𝒗𝒆𝒓𝒔𝒊𝒐𝒏 : 1.3
☆ 𝒑𝒊𝒏𝒈 : `{ms}`
☆ 𝑑𝑎𝑡𝑒 : `{m9zpi}`
☆ 𝑖𝑑 : `{event.sender_id}`
☆ 𝒔𝒐𝒖𝒓𝒄𝒆 ꫀ𝑑𝑤𝑎𝑟𝑑 𝑘ꫀꪀ𝑤𝑎𝑦 : @SC_60**
...
async def _(event):
        ...
        await sython.send_message('@t06bot', 'جاري التجميع بواسطة |ꫀ𝑑𝑤𝑎𝑟𝑑 𝑘ꫀꪀ𝑤𝑎𝑦')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
      await event.reply("""السـورس يعمـل | 𝒔𝒐𝒖𝒓𝒄𝒆 ꫀ𝑑𝑤𝑎𝑟𝑑 𝑘ꫀꪀ𝑤𝑎𝑦
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍

- المطور : ميكائيل | ꫀ𝑑𝑤𝑎𝑟𝑑 𝑘ꫀꪀ𝑤𝑎𝑦

- سورس بسيط يحتوي على الاوامر المهمة التي تحتاجها

قناة السورس : https://t.me/scp_scp106
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)

@sython.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""SY OWNER : @SC_60"""
)
